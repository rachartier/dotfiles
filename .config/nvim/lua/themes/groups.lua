...
function M.get(colors)
  ...
  return {
    ...
    BlinkCmpMenuSelection = { bg = colors.muted, bold = true },
    ...
    NeogitHunkHeader = { bg = U.darken(colors.blue, 0.095, colors.base), fg = U.darken(colors.blue, 0.5, colors.base) },
    ...
    NeogitDiffAdd = { bg = U.darken(colors.green, 0.095, colors.base), fg = U.darken(colors.green, 0.800, colors.base) },
    NeogitDiffAddHighlight = { bg = U.darken(colors.green, 0.345, colors.base), fg = U.lighten(colors.green, 0.850, colors.text) },
    NeogitDiffDelete = { bg = U.darken(colors.red, 0.095, colors.base), fg = U.darken(colors.red, 0.800, colors.base) },
    NeogitDiffDeleteHighlight = { bg = U.darken(colors.red, 0.345, colors.base), fg = U.lighten(colors.red, 0.850, colors.text) },
    NeogitDiffHeader = { fg = colors.blue, bg = default_bg, bold = true },
    NeogitDiffHeaderHighlight = { fg = colors.peach, bg = default_bg, bold = true },
    NeogitCommitViewHeader = { bg = U.darken(colors.blue, 0.300, colors.base), fg = U.lighten(colors.blue, 0.800, colors.text) },
