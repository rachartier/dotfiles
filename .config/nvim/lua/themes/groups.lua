...
function M.get(colors)
  ...
  return {
    ...
    Visual = { bg = colors.surface, bold = false },
    Pmenu = { bg = default_bg },
    PmenuSbar = { bg = colors.surface },
    PmenuThumb = { bg = colors.subtle },
    PmenuMatch = { fg = colors.text, bold = true },
    PmenuMatchSel = { bold = true },
    PmenuExtra = { fg = colors.muted },
    ...
    diffLine = { fg = colors.muted },
    diffIndexLine = { fg = colors.teal },

    -- Treesitter: Identifiers
    ["@variable"] = { fg = colors.text },
    ["@variable.builtin"] = { fg = colors.red },
    ["@variable.parameter"] = { fg = colors.maroon or colors.flamingo },
    ...
    ["@string.regexp"] = { fg = colors.pink or colors.mauve },
    ["@string.escape"] = { fg = colors.pink or colors.mauve },
    ...
    ["@function.macro"] = { fg = colors.pink or colors.mauve },
    ...
    ["@comment.note"] = { fg = colors.base, bg = colors.rosewater or colors.mauve },
    ...
    ["@markup.quote"] = { fg = colors.pink or colors.mauve },
    ["@markup.math"] = { fg = colors.blue },
    ["@markup.environment"] = { fg = colors.pink or colors.mauve },
    ...
    ["@markup.list.unchecked"] = { fg = colors.overlay1 or colors.muted },
    ...
    ["@constructor.python"] = { fg = colors.sky or colors.teal },
    ...
    gitcommitSummary = { fg = colors.rosewater or colors.subtext, italic = true },
    ...
    MiniIconsAzure = { fg = colors.sapphire or colors.teal },
    ...
    BlinkCmpScrollBarGutter = { bg = colors.surface1 or colors.surface },
    BlinkCmpScrollBarThumb = { bg = colors.overlay0 or colors.muted },
    ...
    BlinkCmpKindOperator = { fg = colors.sky or colors.teal },
    BlinkCmpKindTypeParameter = { fg = colors.maroon or colors.flamingo },
    ...
    NeogitDiffAddInline = {
      bg = U.darken(colors.green, 0.500, colors.base),
      bold = true,
    },
    ...
    NeogitDiffDeleteInline = {
      bg = U.darken(colors.red, 0.500, colors.base),
      bold = true,
    },
    ...
    NeogitChangeCopied = { fg = colors.pink or colors.flamingo, bold = true },
    ...
    NeogitGraphWhite = { fg = colors.base },
    ...
    DapBreakpointRejected = { fg = colors.mauve },
    DapLogPoint = { fg = colors.sky or colors.teal },
    DapStopped = { fg = colors.maroon or colors.flamingo },
    ...
    -- diffview.nvim
    DiffviewNormal = { fg = colors.text, bg = default_bg },
    DiffviewWinSeparator = { fg = colors.muted, bg = default_bg },
    ...
    NeotestAdapterName = { fg = colors.maroon or colors.flamingo },
    ...
    rainbow5 = { fg = colors.sapphire or colors.teal },
    rainbow6 = { fg = colors.highlight },
  }
end
