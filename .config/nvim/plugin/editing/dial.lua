...
local function load()
  ...
  local checkboxes_thumbs =
    augend.constant.new({ elements = { "[y]", "[n]" }, word = false, cyclic = true })
  local checkboxes_others =
    augend.constant.new({ elements = { "[f]", "[s]", "[*]", "[!]" }, word = false, cyclic = true })
  local checkboxes_attr =
    augend.constant.new({ elements = { "[?]", "[i]" }, word = false, cyclic = true })
